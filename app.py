...
Official Student Club · Department of Civil Engineering · IIUC (International Islamic University Chittagong)<br/>
{{club_email}} &nbsp;|&nbsp; bKash/Nagad: {{payment_phone}}<br/>
<span style="font-size:.75rem;color:#666;margin-top:6px;display:block;">
  Civision Society | IIUC Civil Club | Civil Engineering Bangladesh | IIUC Civil Engineering | Civision Login | Bangladesh Civil Engineers | Engineers Institution Bangladesh | IIUC Student Club | Civil Engineering Chittagong
</span>
</footer>
<script>
